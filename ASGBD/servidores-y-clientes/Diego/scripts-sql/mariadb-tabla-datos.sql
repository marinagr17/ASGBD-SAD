...
BEGIN
    ...
    WHILE i <= 200 DO
        ...
        VALUES (
            FLOOR(1 + RAND()*50),  -- cliente_id 1-50
            FLOOR(1 + RAND()*20),  -- producto_id 1-20
            FLOOR(1 + RAND()*5),   -- cantidad 1-5
...
-- Ejecutar la generación de 200 ventas
CALL generar_ventas();
-- Opcional: borrar el procedimiento si no lo necesitas más
